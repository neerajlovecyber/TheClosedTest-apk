        ...
        <Card className="border-red-300 bg-red-50 dark:bg-red-950/20 dark:border-red-900/50 mb-6">
          <CardContent className="p-4 flex-row items-start gap-3">
            ...
            <View className="flex-1">
              <Text className="text-base font-bold text-red-700 dark:text-red-400">System Maintenance Area</Text>
            ...
            <View className="flex-row items-start gap-3 mb-4">
              ...
              <View className="flex-1">
                ...
                <Text className="text-xs text-red-600/80 dark:text-red-400/70 mt-1">
                  Permanently deletes all submitted apps, active match testing pairings, proofs, and chat messages. Real user profiles and streaks remain
                  untouched.
                </Text>
              </View>
            </View>
            ...
            <View className="flex-row items-start gap-3 mb-4">
              ...
              <View className="flex-1">
                ...
                <Text className="text-xs text-orange-600/80 dark:text-orange-400/70 mt-1">
                  Deletes simulated QA and stress-testing accounts created during development. Your real admin accounts and verified Google users are completely
                  protected.
                </Text>
              </View>
            </View>
      ...
      <AlertDialog open={showCleanConfirm} onOpenChange={setShowCleanConfirm}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onPress={handleCleanAllApps} className="bg-red-600 hover:bg-red-700">
      ...
      <AlertDialog open={showCleanUsersConfirm} onOpenChange={setShowCleanUsersConfirm}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onPress={handleCleanTestUsers} className="bg-orange-600 hover:bg-orange-700">
