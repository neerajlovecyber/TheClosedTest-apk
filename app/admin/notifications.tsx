    ...
    <SafeAreaView className="flex-1 bg-background" edges={["top", "left", "right", "bottom"]}>
      ...
      <View className="flex-1 items-center justify-center p-8">
        <View className="w-16 h-16 bg-green-500/10 rounded-full items-center justify-center mb-4">
          <Icon as={BellIcon} className="text-green-600 size-8" />
        </View>
        <Text className="text-lg font-bold text-foreground mb-1">Push System Ready</Text>
        <Text className="text-sm text-muted-foreground text-center">Expo push notification tokens are registered and dispatched via the REST backend.</Text>
      </View>
    </SafeAreaView>
  );
}
