...
function CopyableItem({ value, label }: { value: string; label: string }) {
  ...
  return (
    <Pressable onPress={handleCopy} className="flex-row items-center justify-between p-4 rounded-xl bg-primary/10 active:bg-primary/20">
...
function BadgeItem({ icon, label, color, bgColor }: BadgeItemProps) {
  return (
    <View className="items-center mb-3" style={{ width: 75 }}>
      ...
      <Text className="text-[10px] text-center font-medium text-muted-foreground" numberOfLines={2}>
        {label}
      </Text>
    </View>
  );
      ...
      <ScrollView className="flex-1 bg-background" contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
        ...
        <Card className="mb-4 border-primary/30">
          ...
          <CardContent className="pt-1">
            ...
            <CopyableItem label="Google Group Email" value={GOOGLE_GROUP_EMAIL} />
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-2 gap-4">
            <View>
              ...
              <Text className="text-sm text-muted-foreground">
                Google requires closed testers to test for at least 14 consecutive days before your app can be published.
              </Text>
            </View>
            <View>
              <Text className="font-bold text-foreground mb-1">How many testers do I need?</Text>
              <Text className="text-sm text-muted-foreground">
                You need at least 12 testers who complete the 14-day period. We help you find them through mutual swaps.
              </Text>
            </View>
            <View>
              <Text className="font-bold text-foreground mb-1">What if my partner misses a day?</Text>
              <Text className="text-sm text-muted-foreground">
                Their reputation decreases. You can choose partners with higher reputation for more reliability.
              </Text>
            </View>
            <View>
            ...
            <View>
              ...
              <Text className="text-sm text-muted-foreground">
                All developers can unlock all 3 app slots for free in 2 clicks on the Home tab (up to 3 total active apps)!
              </Text>
            </View>
          </CardContent>
        </Card>
