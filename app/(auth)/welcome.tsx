    ...
    <SafeAreaView className="flex-1 bg-background">
      ...
      >
        {ONBOARDING_STEPS.map((step, index) => (
          <View key={index} style={{ width: SCREEN_WIDTH }} className="flex-1 items-center justify-center p-8">
            <View className="items-center justify-center gap-8 w-full">
              ...
              <Animated.View
                ...
                className={cn("w-full aspect-square max-w-[320px] rounded-[48px] items-center justify-center overflow-hidden", step.iconBgClass)}
              >
                <Pressable
              ...
              <View className="gap-4 items-center mt-4">
                <Text className="text-4xl font-black text-center text-foreground tracking-tight leading-tight">{step.title}</Text>
                <Text className="text-center text-lg leading-7 px-2 max-w-xs text-muted-foreground">{step.description}</Text>
              </View>
            </View>
          </View>
        ))}
