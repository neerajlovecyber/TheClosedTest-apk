        ...
        <Card>
          <CardContent className="pt-4">
            ...
            <View className="mb-6">
              ...
              <Text className="text-sm text-muted-foreground mb-3">Go to your app in the Google Play Console and click on the sidebar menu.</Text>
              <Image
            ...
            <View className="mb-6">
              ...
              <Text className="text-sm text-muted-foreground mb-3">Navigate to "Testing" → "Closed testing" in the sidebar menu.</Text>
              <Image
            ...
            <View className="mb-6">
              ...
              <Text className="text-sm text-muted-foreground mb-3">Click on "Manage track" for your closed testing track.</Text>
              <Image
            ...
            <View className="mb-6">
              ...
              <Text className="text-sm text-muted-foreground mb-3">In the track settings, click on "Testers" tab to manage your tester list.</Text>
              <Image
            ...
            <View className="mb-4">
              ...
              <Text className="text-sm text-muted-foreground mb-3">Add the Google Group email below to your testers list:</Text>
              <CopyableEmail />
              <Image
            ...
            <View className="mb-6">
              ...
              <Text className="text-sm text-muted-foreground mb-3">After adding the Google Group, click "Save" to apply your changes.</Text>
              <Image
            ...
            <View className="mb-6">
              ...
              <Text className="text-sm text-muted-foreground mb-3">Navigate to "Publishing overview" in the sidebar to publish your changes.</Text>
              <Image
            ...
            <View className="mb-4">
              ...
              <Text className="text-sm text-muted-foreground mb-3">Click "Send for review" to submit your tester list changes to Google.</Text>
              <Image
