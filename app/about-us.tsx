        ...
        <View className="flex-1 px-4 py-6 gap-4">
          ...
          <Section icon={RocketIcon} title="Our Mission" iconColor="bg-blue-500">
            <Text className="text-foreground/80 leading-7">
              We are dedicated to helping developers test their apps efficiently. The Closed Test facilitates seamless connection between testers and
              developers, ensuring your app is ready for the world.
            </Text>
          </Section>
          ...
          <Section icon={UsersIcon} title="What We Do" iconColor="bg-green-500">
            ...
            <View className="gap-2 bg-muted/30 rounded-xl p-4 mt-2">
              <Text className="text-foreground/80 leading-6">
                • <Text className="font-semibold">Mutual Testing</Text> - Connect with other developers for app testing exchanges.
              </Text>
              <Text className="text-foreground/80 leading-6">
                • <Text className="font-semibold">Daily Proofs</Text> - Verify testing with screenshot uploads.
              </Text>
              <Text className="text-foreground/80 leading-6">
                • <Text className="font-semibold">Reputation System</Text> - Build trust within the community.
              </Text>
            </View>
          </Section>
          ...
          <Section icon={HeartIcon} title="Why Choose Us" iconColor="bg-violet-500">
            <Text className="text-foreground/80 leading-7">
              We understand the challenges developers face when trying to meet Google Play's closed testing requirements. That's why we built a community-driven
              solution that makes it easy to find reliable testers.
            </Text>
          </Section>
          ...
          <Section icon={MailIcon} title="Contact Us" iconColor="bg-cyan-500">
            <Text className="text-foreground/80 leading-7">Have questions or feedback? We'd love to hear from you!</Text>
            <Button size="lg" className="rounded-2xl flex-row gap-2 mt-2" onPress={() => handleLink("mailto:Theneerajsec@gmail.com")}>
          ...
          <View className="mt-4 pt-6 border-t border-border items-center gap-1">
            <Text className="text-sm text-muted-foreground/60">© Theneerajsec 2025</Text>
            <Text className="text-sm text-muted-foreground/60">All rights reserved</Text>
          </View>
        </View>
      </ScrollView>
    </>
