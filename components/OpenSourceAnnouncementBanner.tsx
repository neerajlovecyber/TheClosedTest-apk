        ...
        <CardContent className="p-4">
          ...
          <View className="flex-row items-center justify-between mb-2">
            <View className="flex-row items-center gap-2">
              ...
              <Text className="text-xs font-extrabold text-blue-600 dark:text-blue-400 uppercase tracking-wider">Major Update • Open Source</Text>
            </View>
            <TouchableOpacity onPress={handleDismiss} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }} className="p-1 rounded-full active:bg-muted/40">
              <Icon as={XIcon} className="size-4 text-muted-foreground" />
            </TouchableOpacity>
          </View>

          {/* Headline & Body */}
          <Text className="text-base font-bold text-foreground mb-1">The Closed Test is now 100% Open Source! 🚀</Text>
          ...
          <View className="flex-row items-center gap-2">
            ...
            <Button size="sm" variant="outline" className="rounded-xl h-9 px-4" onPress={handleDismiss}>
