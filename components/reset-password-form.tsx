    ...
    <View className="gap-6">
      <Card className="border-border/0 shadow-none sm:border-border sm:shadow-sm sm:shadow-black/5">
        <CardHeader>
          ...
          <CardDescription className="text-center sm:text-left">Enter the code sent to your email and set a new password</CardDescription>
        </CardHeader>
        <CardContent className="gap-6">
          <View className="gap-6">
            ...
            <View className="gap-1.5">
              ...
              />
              {error.code ? <Text className="text-sm font-medium text-destructive">{error.code}</Text> : null}
            </View>
